...
class DeleteDeliveryLineUseCase implements BaseUseCase<int, void> {
  final Repository _repository;

  DeleteDeliveryLineUseCase(this._repository);

  @override
  Future<Either<Failure, void>> execute(int id) async {
    return await _repository.deleteDelivaryLine(id: id);
  }
}
