...
class TraderInvoiceFawater extends StatelessWidget {
  ...
  int index;
   TraderInvoiceFawater({super.key, required this.traderInvoiceModel,required this.index});
...
class SupplierInvoiceFawater extends StatelessWidget {
  ...
  int index;
  SupplierInvoiceFawater({super.key, required this.supplierInvoiceModel,required this.index});
